extends Node
## The musical-tile puzzle (room 6 / Level_6): the glow is earned by stepping all
...
## Room 6 in play order; "Level_6" is its LDtk identifier.
const ROOM := "Level_6"
...
func _ready() -> void:
	...
	_check(room != null, "the world has room 6 (Level_6)")
	if room == null:
		return _finish()
