...
## room. Level_4's ceiling row is unpainted above the ledge that holds its Exit,
...
##     2: Vector2(912, 180),    # Level_4, the Exit ledge under the ceiling gap
##     3: Vector2(984, 180),    # Level_5, top-left shelf by the PlayerStart
##
...
## 12px tall on an 8px grid, so he needs two cells just to fit; three keeps him out
